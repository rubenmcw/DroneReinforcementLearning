...
fileName = "RUBENCustomCityNEWNotCustom.txt"
...
for _ in range(NUM_ITERATIONS):
    ...
    agent = BayesianQLearningAgent(alpha=0.1, gamma=0.99, epsilon=0.1, num_states=num_states, num_actions=num_actions, prior_mean=0, prior_variance=1, adapt_alpha=True, adapt_epsilon=True)
