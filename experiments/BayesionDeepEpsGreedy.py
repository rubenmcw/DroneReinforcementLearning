...
generatedStartState = np.array([13, 20])
...
agent = BayesianQLearningAgent(alpha=0.1, gamma=0.99, epsilon=1.0, num_states=num_states, num_actions=num_actions, prior_mean=0, prior_variance=1)
