...
generatedStartState = np.array([20, 5])
...
print(f"The answer is: {GLOBAL_ART[generatedStartState[0]][generatedStartState[1]] == OBSTACLE_CHAR}")
...
DQN("MlpPolicy", env, verbose=1, tensorboard_log=log_path)
...
for i in range(10000):
    ...
    if i % 100 == 0:
        ...
        while not done:
            ...
            state = np.argmax(state)
            total_reward += reward
        print("Total reward:", total_reward, "Successful?:", info['successful'], "num steps: ", numSteps)

agent.save("posterior_mean.csv")
env.close()